...
public class TelegramBotClient {
    ...
    public void sendMarkdownMessage(long telegramChatId, String messageToTelegram) {
        sendMessageWithParseMode(telegramChatId, messageToTelegram, "Markdown");
    }

    public void sendMessage(long telegramChatId, String messageToTelegram) {
        sendMessageWithParseMode(telegramChatId, messageToTelegram, "");
    }

    public void sendMessageWithParseMode(long telegramChatId, String messageToTelegram, String parseMode) {
    ...
    public void blockingSendMessage(long telegramChatId, String messageToTelegram, String parseMode) {
